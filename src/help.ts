...
${commandLine("bobster completion <bash|zsh|fish>", theme)}
...
const COMMAND_HELP = {
  ...
  completion: {
    usage: "bobster completion <bash|zsh|fish>",
    description: "Print a shell completion script for Bobster commands and item names.",
    options: [
      "--help              Show help.",
    ],
  },
