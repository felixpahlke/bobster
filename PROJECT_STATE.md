...
- Browse surfaces now share the same metadata policy: keep versions out of rows and only surface deprecated status while preserving metadata-backed filtering.
